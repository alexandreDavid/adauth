...
const techsJson = [
  ...
  },
  {
    key: 'react',
    title: 'React',
    logo: 'http://linkzikjs.io/assets/imgs/react.png',
  ...
  },
  {
    key: 'angular1',
    title: 'Angular 1',
    logo: 'http://linkzikjs.io/assets/imgs/angular1.png',
    ...
    it('should mock the techs and render 3 elements <tech>', async(inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
      return tcb
        ...
        .then((fixture: ComponentFixture<any>) => {
          ...
          expect(techs.querySelectorAll('linkzik-tech').length).toBe(3);
        });
    })));
  });
});
